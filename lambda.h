...
typedef enum {
  EXP_UNIT,
  EXP_INT,    // Integer literal (e.g., 42)
  EXP_BOOL,   // Boolean literal (e.g., true, false)
  EXP_VAR,    // Variable reference (e.g., x)
  EXP_LAMBDA, // Lambda abstraction (e.g., λx.e)
  EXP_APPLY,  // Function application (e.g., f x)
